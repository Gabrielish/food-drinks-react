    ...
    >
      {data && data.length > 0 ? (
        data.map((item) => (
          <div
            key={item?.id}
            className="w-275 h-[175px] min-w-[275px] md:w-300 md:min-w-[300px]  bg-cardOverlay2 rounded-lg py-2 px-4  my-12 backdrop-blur-lg hover:bg-orange-200 flex flex-col items-center justify-evenly relative"
          >
